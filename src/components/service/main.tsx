  ...
  return (
    ...
    >
      <div className="flex flex-col max-md:hidden">
        <h2 className="text-black text-[90px]/[120%] max-md:text-[36px]/[120%] font-cormo italic max-md:pr-20">
      ...
      <div className="flex md:hidden text-black text-[90px]/[120%] max-md:text-[36px]/[120%]">
        <h2 className="font-cormo">
          <span className="italic">
            Digital Solutions <br /> That Build,
          </span>{" "}
          <span className="font-sans text-black font-extrabold">
            {" "}
            Launch, and Grow Brands
          </span>{" "}
        </h2>
            ...
            >
              <div className="flex justify-between items-center">
                ...
                <div className="w-[271px] h-[228px] max-md:w-[80px] max-md:h-[60px] glass_effect flex flex-col justify-center items-center">
                  <span className="text-[32px]/[120%] max-md:text-[9px]/[120%] font-light uppercase">
                    Clients
                  </span>
                  <span className="text-[128px]/[120%] max-md:text-[33px]/[120%] font-bold">
                    {service.clients}
                  </span>
                </div>
              </div>
              <p className="text-[28px]/[120%] max-md:text-[10px]/[120%] font-normal">
                {service.description}
              </p>
