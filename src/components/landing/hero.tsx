...
export default function Home() {
  return (
    <div
      className="min-h-screen overscroll-contain pt-44 max-md:pt-16 pb-24 max-md:pb-8 px-15 max-md:px-3.5"
      style={{
    ...
    >
      <div className="mt-24 max-md:mt-2 max-w-[950px] max-md:w-full mx-auto max-md:mx-0 flex flex-col gap-15 max-md:gap-4">
        ...
        <div className="text-2lg italic text-white font-light mx-20 max-md:mx-0 text-center">
        ...
        <div className="flex justify-center items-center mt-34 max-md:mt-9">
          <Button
